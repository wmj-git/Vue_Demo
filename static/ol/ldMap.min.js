...
//瑙ｅ喅鐐瑰嚮鍧愭爣鍒楄〃锛岃绱犳病鏈夊畬鍏ㄥ憟鐜板湪鍙鍖虹殑bug
            ol.Overlay.prototype.panIntoView_ = function () {
                ...
                if (!ol.extent.containsExtent(mapRect, overlayRect)) {
                    // 鐢变簬瑕嗙洊鍥惧眰鏈夋椂鍊欎笉鏄畬鍏ㄥ湪鍙鍖猴紝鎵€浠ラ渶瑕佺Щ鍔ㄨ鐩栧浘灞�
...
//姣斾緥灏鸿浆鍒嗚鲸鐜�
            utils.getResolutionForScale = function (scale, units) {
                var resolution;
                //澶勭悊cgcs2000鎴杦gs84鍦扮悊鍧愭爣绯�,units榛樿鍗曚綅涓哄害锛�1搴︾害涓�111194.872221777绫�
                if (units == "degrees" || !units) {
                    //浠ュ害涓哄崟浣嶏紝
                    resolution = scale * 0.0254000508 / 96 / 111194.872221777;
                } else if (units == "m") {
                    //鍗曚綅涓虹背锛屽鐞嗗ⅷ鍗℃墭绛夋姇褰卞潗鏍囩郴
                    //浠ョ背涓哄崟浣�
            ...
            utils.extend = function (dest) {
                var i, j, len, src;
                //TODO:arguments鍦╡s6涓凡杩囨椂锛屽緟鐢ㄤ笉瀹氬弬鏁版浛浠ｏ細http://www.infoq.com/cn/articles/es6-in-depth-rest-parameters-and-defaults/
             ...
             * 鏍规嵁鍦扮悊鍧愭爣浣嶇疆锛屽皢绫宠浆鎹㈡垚缁忕含搴︺€�
             *
             * Parameters:
             * meter - {Number} 瑕佽浆鎹㈢殑鍦扮悊鍧愭爣銆�
             * lonlat - {<Geo.LonLat>} 缁忕含搴︺€�
             */
            utils.meterToDegree = function (meter, lonlat) {
                var a = 0.00000899; //璧ら亾涓婄殑璺濈1鍏噷=0.000008993220293搴�
                var templat = lonlat.lat;
                return meter * (a / Math.cos(OpenLayers.Util.rad(templat)));
            };

//TODO:鐧惧害鍧愭爣绯昏浆cgcs2000鍧愭爣绯�,鍋忕Щ鍊肩敱鏁板伐閮ㄦ彁渚�
...
//鍧愭爣杞崲宸ュ叿
        ...
        /***/ (function(module, exports, __webpack_require__) {
             ...
             *		- duration {number} 鍔ㄧ敾鎵ц鏃堕棿
             *		- revers {bool} 鏄惁鍙嶈繃鏉ユ墽琛�
             *		- fade {ol.easing} 鍔ㄧ敾绫诲瀷
             */
            ...
            /** 缁樺埗瑕佺礌
             *	@param {olx.animateFeatureEvent} 瑕佺礌鍔ㄧ敾浜嬩欢
             *	@param {ol.geom} 瑕佺粯鍒剁殑瑕佺礌
             *	@param {ol.geom} 瑕佺礌闃村奖鏁堟灉
             */
            ...
            /** 缁樺埗瑕佺礌鍒板湴鍥�
             *	@fires animationend
             *	@param {ol.Feature} feature 杩愬姩鐨勮绱�
             *	@param {ol.featureAnimation|Array<ol.featureAnimation>} 瑕佺礌鍔ㄧ敾瀵硅薄
             */
            ol.Map.prototype.animateFeature =

                /** 娣诲姞鍔ㄧ敾瑕佺礌瀵硅薄鍒板浘灞�
                 *	@fires animationend
                 *	@param {ol.Feature} feature 鍔ㄧ敾瑕佺礌
                 *	@param {ol.featureAnimation|Array<ol.featureAnimation>} 瑕佺礌鍔ㄧ敾瀵硅薄
                 *	@return {animationControler}
                 *		- start {function} 寮€濮嬫墽琛屽姩鐢�
                 *		- stop {function} 缁撴潫鍔ㄧ敾
                 *		- isPlaying {function} 鍒ゆ柇鍔ㄧ敾鏄惁姝ｅ湪鎵ц
                 */
                ol.layer.Vector.prototype.animateFeature = function (feature, fanim) {
                    ...
                    // 姝ｆ槸鍥犱负璁剧疆浜唖etStyle,鎵嶈Е鍙戜簡postcompose浜嬩欢銆�
                    feature.setStyle(fanim.hiddenStyle || []);

                    // 瀹氫箟鍔ㄧ敾鐩稿叧灞炴€�
                    var event = { // 鐭㈤噺鍥惧眰缁樺埗涓婁笅鏂�
                        vectorContext: null,
                        frameState: null, //?
                        start: 0,
                        time: 0,
                    ...
                    function animate(e) {
                        ...
                        //event.elapsed = 褰撳墠鎵ц鐨勬椂闂�/鍔ㄧ敾鎬绘椂闂�
                        ...
                        // 浠讳綍鍦板浘娓叉煋鎿嶄綔閮戒細瑙﹀彂postcompose浜嬩欢锛屽寘鎷绱犳覆鏌擄紝鐡︾墖娓叉煋绛夛紝杩欓噷鏄槸鍛婄煡鍦板浘褰撳墠鍦板浘鐨勭姸鎬侊細鍔ㄧ敾鏈粨鏉�
                        e.frameState.animate = true;
                    }

                    // 鍋滄鍔ㄧ敾
                    function stop(options) {
                        //绉婚櫎postcompose鐨勪簨浠剁洃鍚�
                        ol.Observable.unByKey(listenerKey);
                        listenerKey = null;
                        feature.setStyle(style);
                        // Send event 骞朵笖娲惧彂鍔ㄧ敾缁撴潫浜嬩欢
                    ...
                    function start(options) {
                        if (fanim.length && !listenerKey) {
                            //娉ㄥ唽娓叉煋浜嬩欢鐩戝惉銆傝Е鍙慳nimate鏂规硶鐨勫叧閿唬鐮�
        ...
        /***/ (function(module, exports, __webpack_require__) {
             ...
             * 缁ф壙featureAnimation,瀹炵幇绾胯矾鑷姩澧為暱鐨勫姩鐢汇€�
             */
...
//TODO:琛ュ厖ol3涓殑鎺ュ彛锛岃绠椾袱鐐归棿闀垮害鐨刟pi,鏀规帴鍙ｅ簲璇ヨ鏀惧埌geom鎺ュ彛涓�
            ...
            /**
             * 瀹炴椂缁樺埗绾�
             * @param {Number} t   涓哄綋鍓嶅姩鐢绘墽琛岀殑鏃堕棿
             * @param {Number} duration  鍔ㄧ敾鎵ц鐨勬€绘椂闂�
             * @param {Number} length 绾跨殑闀垮害
             * @return {array} coordinates 绾跨殑鐐归泦鍚�
             * @api
             */
            ol.featureAnimation.Increase.prototype._drawAnimFrame = function (t, duration, length, coordinates, e) {
                ...
                //鎵ц鏃堕棿/鎬荤殑杩愯鏃堕棿*鎬婚暱搴�=targetLength锛堣繍琛宼鏃堕棿鍚庢墽琛岀殑闀垮害锛�
...
//TODO: L鍛戒护绌洪棿鏄负浜嗗吋瀹瑰惔灏旂晠閽堝鎴戠鏈嶅姟灏佽鐨凙PI鍋氱殑鍏煎锛屽悗闈㈤渶瑕佺粺涓€鏀规垚ld
        ...
        /***/ (function(module, exports, __webpack_require__) {
            ...
            /**
             * create by zxj
             * ol.source.ImageArcGISRest鍔犺浇Arcgis MapServer鎴朓mageServer鏈嶅姟鏃惰姹傛湇鍔″湴鍧€涓繀椤诲寘鍚€淢apServer鈥濇垨鈥淚mageServer鈥濆瓧绗︿覆銆�
             * 鑰屼骇鍝佹椂绌轰俊鎭簯骞冲彴--->闂ㄦ埛---->涓汉涓績---->鎴戠殑鏈嶅姟 瀵规湇鍔＄被鍨嬩负MapServer鐨勮绱犳湇鍔¤繘琛屸€滈瑙堚€濇搷浣滄椂锛� 浼氫娇鐢╫l.source.ImageArcGISRest API锛�
             * 浣嗕釜浜轰腑蹇冪殑鏈嶅姟鍦板潃閮芥槸浠ｇ悊鍦板潃锛屽湴鍧€涓笉鍖呭惈鈥淢apServer鈥濇垨鈥淚mageServer鈥濆瓧绗︿覆锛屼細瀵艰嚧鏈嶅姟鍔犺浇鏃舵姤閿欍€�
             *      涓鸿В鍐宠繖涓棶棰橈紝淇敼浜嗚绫荤殑绉佹湁鏂规硶getRequestUrl_銆�
             *      闅愯棌闂锛屾湰娆′慨鏀瑰彧瑙ｅ喅浜哅apServer绫诲瀷鏈嶅姟浠ｇ悊鍦板潃鐨勫姞杞斤紝ImageServer绫诲瀷鏈嶅姟浠ｇ悊鍦板潃鍔犺浇鐓ф棫浼氭姤閿欍€�
             *      鏈湴淇敼鍩轰簬openlayers v4.6.5鐗堟湰
